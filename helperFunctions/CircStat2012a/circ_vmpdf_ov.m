function [p alpha] = circ_vmpdf_ov(alpha, thetahat, kappa)

%% This code contains one modification to the code listed below in order to minimize numerical overflow.
...
% evaluate with logs to avoid numerical instability?
